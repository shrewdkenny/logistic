  ...
  <div class="mt-10 grid grid-cols-1 gap-2 px-3 lg:grid-cols-2 lg:px-28">
    ...
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        class="mt-4 size-14 text-[#3799fb]"
      >
        <path
          fill-rule="evenodd"
    ...
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        class="mt-4 size-14 text-red-500"
      >
        <path
          fill-rule="evenodd"
    ...
    <div
      class="flex h-40 flex-col items-center justify-center rounded-lg bg-[#ffffff]"
    >
      <!-- class="flex h-[130px] w-full flex-col items-center justify-center rounded-lg bg-[#ffffff] lg:h-[170px] lg:max-w-[400px]" -->
      ...
      <svg
        ...
        stroke-width="1.5"
        stroke="currentColor"
        class="mt-4 size-14 text-[#f5a831]"
      >
        <path
    ...
    >
      ...
      <svg
        ...
        stroke-width="1.5"
        stroke="currentColor"
        class="mt-4 size-14 text-[#66cc66]"
      >
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
